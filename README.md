...
- 🌓 **Tactile 3D Skeuomorphic Theme Switcher** (Persistent Dark / Light mode)
- 🍏 **Apple-Style Springy Dock Navbar** (macOS cursor magnification physics via Framer Motion)
- 🃏 **25-Zone 3D Cyber Tilt Cards** (Tactile mouse tracking, scanlines & neon particles)
